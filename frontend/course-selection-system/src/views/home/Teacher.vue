<template>
  <div class="notice">
	  ...
	  <el-button type="primary" @click="search()" style="margin-left: 15px;">查询</el-button>
	   <el-button type="success" @click="AddNotice()" icon="el-icon-plus" style="position: absolute;right: 15px;">添加教师信息</el-button>
      <el-table border :fit="true" 
        ...
        <el-table-column prop="NetID" sortable label="教工号">
          <template slot-scope="{ row, $index }">
...
<script>
import Addstudent from "../../components/addteacher/Addteacher.vue";
